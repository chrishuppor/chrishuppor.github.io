      ...
      4. 步入401240
         ...
         5. 接着就是梦寐以求的字符串匹配部分了。
            ...
            2. 将Input打乱顺序存储到内存，这些内存地址就是接下来要使用的东西，注意记录对应关系就好，不再细说。
               ...
               6. 检查[0x40CD30]^0x46是否为0x8,。但是之前没有记录0x40CD30对应input的哪一位，不过查看0x40CD30发现是我input的第5个字符，所以应该是input[4]。因此，input[4] == 'N' 

               7. [0x40CCFC] rol 4 == 0x14，所以input[5] == 0x14 ror 4 == 0x65 == 'A'
